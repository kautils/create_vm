...
//
//
//int tmain_create_vm(const char * directory_of_system_jars/*void *(*dlopen)(const char *,int),void *(*dlsym)(void *,const char *),int(*dlclose)(void *)*/,int dlop){
...
////            vm.create_once(dlopen,dlsym,dlclose,dlop);
//            vm.create_once(dlop);
